# Knowledge source adapters (WP-E44)

This document describes the P0 knowledge source adapters in
...
The P0 adapter set includes four credential-free sources:
...
license terms. For the P0 sources the attribution strings are:
...
WP-E44 is gated by `scripts/checks/wp44-gate.py` and the hermetic tests under
`tests/knowledge/sources/`:
