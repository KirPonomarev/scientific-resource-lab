...
def default_source_policy_cards() -> tuple[SourcePolicyCard, ...]:
    ...
    return (
        ...
        SourcePolicyCard(
            ...
            "CSLib",
            active,
            "https://api.github.com/repos/leanprover/cslib/commits",
            "pinned public formal-library repository metadata lookup",
            "Apache-2.0 source identity pinned in Lean corpus pins and A11 endpoint descriptor",
            True,
            "srl.knowledge.sources.github_corpus",
            "A11 bounded adapter over pinned GitHub commit",
        ),
        SourcePolicyCard(
            "erdos_problems",
            "Erdos Problems",
            active,
            "https://api.github.com/repos/teorth/erdosproblems/commits",
            "pinned public problem-list repository metadata lookup",
        ...
        SourcePolicyCard(
            ...
            "Formal Conjectures",
            active,
            "https://api.github.com/repos/google-deepmind/formal-conjectures/commits",
            "pinned public conjecture repository metadata lookup",
            "Apache-2.0 source identity pinned in Lean corpus pins and A11 endpoint descriptor",
            True,
            "srl.knowledge.sources.github_corpus",
            "A11 bounded adapter over pinned GitHub commit",
