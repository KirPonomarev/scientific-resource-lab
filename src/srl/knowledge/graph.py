...
def default_source_policy_cards() -> tuple[SourcePolicyCard, ...]:
    ...
    wait_adapter = KnowledgeSourceStatus.WAIT_ADAPTER
    wait_terms = KnowledgeSourceStatus.WAIT_TERMS
    return (
        SourcePolicyCard(
            "openalex",
            "OpenAlex",
        ...
        SourcePolicyCard(
            ...
            "citation graph lookup only after adapter and terms fixture are added",
            "public terms require adapter-specific fixture before ACTIVE",
            True,
            None,
            "WAIT_ADAPTER: no bounded parser in this repository yet",
        ),
        SourcePolicyCard(
            "zbmath",
            "zbMATH Open",
            wait_terms,
            "https://zbmath.org",
            "mathematical metadata lookup only after terms and robots policy fixture",
            "WAIT_TERMS",
            True,
            None,
            "WAIT_TERMS: terms and robots evidence not pinned",
        ),
        SourcePolicyCard(
            "lmfdb",
            "LMFDB",
            wait_adapter,
            "https://www.lmfdb.org",
            "mathematical object metadata lookup after bounded adapter",
            "public site terms require source-specific fixture before ACTIVE",
            True,
            None,
            "WAIT_ADAPTER: no bounded parser in this repository yet",
        ),
        SourcePolicyCard(
            ...
            wait_adapter,
            "registry:CSLib",
            "formal-library metadata only after source identity and license fixture",
            "WAIT_ADAPTER",
            True,
            None,
            "WAIT_ADAPTER: source identity and parser not yet admitted",
        ),
        SourcePolicyCard(
            "erdos_problems",
            "Erdos Problems",
            wait_adapter,
            "registry:ErdosProblems",
            "problem-list metadata only after public source and license fixture",
            "WAIT_ADAPTER",
            True,
            None,
            "WAIT_ADAPTER: source identity and parser not yet admitted",
        ...
        SourcePolicyCard(
            ...
            "Formal Conjectures",
            wait_adapter,
            "registry:FormalConjectures",
            "conjecture metadata only after source identity and license fixture",
            "WAIT_ADAPTER",
            True,
            None,
            "WAIT_ADAPTER: source identity and parser not yet admitted",
